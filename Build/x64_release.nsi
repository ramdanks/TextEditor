...
!define PRODUCT_DIR_REGKEY "Software\Microsoft\Windows\CurrentVersion\App Paths\DesktopGUI.exe"
...
!insertmacro MUI_PAGE_LICENSE "..\x64\Release\license\app.txt"
; Directory page
...
OutFile "Memoriser[1.0 Beta]-Release.exe"
...
Section "MainSection" SEC01
  SetOutPath "$INSTDIR"
  SetOverwrite try
  File "..\Build\x64\Release\Compressor.exe"
  File "..\Build\x64\Release\memoriser.exe"
  File "..\LICENSE.txt"
